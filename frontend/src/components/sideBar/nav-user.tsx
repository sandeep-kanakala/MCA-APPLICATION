    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <DropdownMenu>
          ...
          <DropdownMenuContent
            className="w-(--radix-dropdown-menu-trigger-width) min-w-56 rounded-lg  bg-white border-none shadow-lg"
          ...
          >
            ...
            <DropdownMenuItem
              ...
              className={`
                  ...
                  transition-colors duration-200 rounded-none cursor-pointer text-[red]
                `}
            >
              <LogOut />
              Log out
